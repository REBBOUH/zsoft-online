...
import { Doctor, IConfiguration, IDoctor } from 'app/components';
...
export class DoctorService {
    ...
    updateConfigurations(doctor_id: any, configuration: IConfiguration[]): Observable<HttpResponse<any>> {
        return this.http.put<IConfiguration>(`${this.resourceUrl}/configuration/${doctor_id}`, configuration, { observe: 'response' });
    }

    getConfigurations(doctor_id: any): Observable<HttpResponse<IConfiguration[]>> {
        return this.http.get<IConfiguration[]>(`${this.resourceUrl}/configuration/${doctor_id}`, { observe: 'response' });
    }
}
